...
<article itemscope itemtype="http://schema.org/Event">
    <header>
        <h1 itemprop="name">Manchester Tech Nights #6</h1>
        <p><a href="https://twitter.com/mcrtechnights" class="twitter-follow-button">Follow @mcrtechnights</a></p>
        <h2><meta itemprop="startDate" content="2014-12-09T19:00:00Z">Tuesday 9th December 2014, 7pm</h2>
        ...
        <p><a href="http://lanyrd.com/2014/mcrtechnights-december/">Attend on Lanyrd</a></p>
    </header>
    <section>
        <h1>Headline Speakers</h1>
        <div itemprop="subEvent" itemscope itemtype="http://schema.org/Event">
            <h2 itemprop="name">Designing for displays that don't exist yet</h2>
            <p itemprop="description">
                <em itemprop="performer" itemscope itemtype="http://schema.org/Person"><span itemprop="name">Rosie Campbell</span></em>
            </p>
        </div>
    </section>
    <section>
        ...
        <div itemprop="subEvent" itemscope itemtype="http://schema.org/Event">
            ...
            <p itemprop="description">
                We're always looking for new speakers or interesting talks from Manchester's tech community. We have
                a few slots left for our December event - if you'd like to talk, please e-mail
                <a href="mailto:hello@manchestertechnights.org">hello@manchestertechnights.org</a>.
            </p>
        </div>
        <div itemprop="subEvent" itemscope itemtype="http://schema.org/Event">
            <h2 itemprop="name">You?</h2>
            <p itemprop="description">
                There 30 second 'elevator' slots available on the night for anyone who wants to talk,
                just speak to an organiser on the night for the elevator slots.
            </p>
        </div>
    </section>
</article>
<nav>
    ...
    <ol>
        <li><a href="/5/">#5 - Hello PlayStation!</a>
